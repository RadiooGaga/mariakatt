  ...
  return (
    ...
    <section className='bioSection'>
      ...
      <div className='biographyDiv'>
        ...
        <br />
        <br />
        Me mudo a Málaga en 2022 y aquí, realizo estudios de programación web full stack durante 2 años en <strong>The Power MBA</strong>. Actualmente vivo en Málaga y tanto el maquillaje y el hair art como la programación son mis actuales pasiones.
