...
const galleryItems = [
  ...
  { img: `https://res.cloudinary.com/${micloudinary}/image/upload/v1742998707/makeup/hair/peinado_trenzado_lcpmr9.jpg`, caption: "rope braids", className: 'pelo', color: "whitesmoke"},
