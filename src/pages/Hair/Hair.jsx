...
const galleryItems = [
  ...
  { img: `https://res.cloudinary.com/${micloudinary}/image/upload/v1742998705/makeup/hair/recogido-graduacion_xskytd.webp`, caption: "",className: 'pelo4',  color: "whitesmoke"},
  { img: `https://res.cloudinary.com/${micloudinary}/image/upload/v1742998705/makeup/hair/bob_es1osh.jpg`, caption: "", className: 'pelo5',  color: "whitesmoke"  },
